    ...
    <main className="coming_soon_page flex-grow flex items-center justify-center px-6 py-24 sm:py-32 lg:px-8 bg-gray-50 h-[calc(100vh-38.3rem)]">
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            href="/"
            className="px-[2rem] md:px-[3rem] py-[1rem] md:py-[1.5rem] text-[2rem] md:text-[2.5rem] font-semibold shadow-sm bg-[var(--color-fa)] hover:bg-[var(--color-06)] hover:!text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition duration-200 go_back__btn"
          >
            Back to Homepage
          </Link>
        </div>
